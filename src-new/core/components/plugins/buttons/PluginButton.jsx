...
export default function PluginButton({
  ...
  containerClassName = "w-10 h- items-center justify-center border border-gray-50 p-1 rounded bg-gradient-to-t from-gray-200 via-white to-gray-100 cursor-grab hover:bg-gray-50",

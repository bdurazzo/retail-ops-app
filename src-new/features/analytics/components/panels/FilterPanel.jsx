// --------------------------------------------------------
// FilterPanel.jsx – Simple tab click tracker with vertical support
// --------------------------------------------------------
      ...
      <div className="flex relative z-10">
        <div className="flex-col h-full">
          {tabs.map((tab, index) => {
            ...
            const Icon = tab.icon;
            return (
              <div className="flex" key={tab.id}>
              <button
                onClick={() => handleTabClick(tab.id)}
                className={` border-r border border-gray-200 shadow w-8 h-[50px] flex items-center justify-center transition-colors duration-[50ms] focus:outline-none

...
import { IconChartHistogram, IconTable, IconLayoutRows, IconTableOptions } from '@tabler/icons-react'

export default function DataToolbar({ currentView, onViewChange }) {
  const views = [
    { key: 'table', label: <IconTable size={18} />, title: 'Table View' },
    { key: 'data', label: <IconTableOptions size={18} />, title: 'Data Table View' },
    { key: 'grouped', label: <IconLayoutRows size={18} />, title: 'Grouped View' },
